...
import ru.hogwarts.schooll.service.AvatarService;
...
public class AvatarController {
    ...
    public void downloadAvatarFromFileSystem(@PathVariable Long id, HttpServletResponse response)
            throws IOException{
        avatarService.downloadAvatarFromFileSystem(id, response);
        }
    @GetMapping
    public Page<Avatar> getWithPageable(@RequestParam Integer page, @RequestParam Integer count)
            throws IOException{
